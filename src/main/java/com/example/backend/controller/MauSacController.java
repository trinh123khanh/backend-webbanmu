...
public class MauSacController {
    ...
    @PostMapping
    public ResponseEntity<MauSacResponse> create(@Valid @RequestBody MauSacRequest request) {
        return ResponseEntity.status(HttpStatus.CREATED).body(service.create(request));
    }

    @PutMapping("/{id}")
    public ResponseEntity<MauSacResponse> update(@PathVariable Long id, @Valid @RequestBody MauSacRequest request) {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<MauSacResponse> getById(@PathVariable Long id) {
